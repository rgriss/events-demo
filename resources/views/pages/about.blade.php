...
@section('content')
    <p class="visible-xs-block alert alert-warning"><strong>Heads up!</strong> <i class="fa fa-code"></i> Code samples on this page are best viewed on larger screens.</p>
...
EOT;
    ...
    <p>Just in case, here's a  button leading to the solution: <a class="btn btn-lg btn-primary" href="event/{{$event->id}}/register"><i class="fa fa-plus"></i> Sign Up for the next Event</a></p>
